...
HLS_SOURCES = ../../../../ocnn6_testbench.cpp ../../../../streaming_bitmap_constructor.cpp ../../../../morton_reorder_buffer.cpp ../../../../dynamic_access.cpp ../../../../systolic_array.cpp ../../../../complete_pipeline.cpp ../../../../ocnn6_net.cpp
...
$(ObjDir)/ocnn6_testbench.o: ../../../../ocnn6_testbench.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../ocnn6_testbench.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ocnn6_testbench.d
...
$(ObjDir)/ocnn6_net.o: ../../../../ocnn6_net.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../ocnn6_net.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ocnn6_net.d
