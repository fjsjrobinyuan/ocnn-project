...
entity minkowski_net_14_layer_pipeline_control_s_axi is
generic (
...
end entity minkowski_net_14_layer_pipeline_control_s_axi;
...
architecture behave of minkowski_net_14_layer_pipeline_control_s_axi is
    ...
    constant ADDR_FINAL_OUTPUT_FULL_CUBIC_DATA_0   : INTEGER := 16#10#;
    constant ADDR_FINAL_OUTPUT_FULL_CUBIC_DATA_1   : INTEGER := 16#14#;
    constant ADDR_FINAL_OUTPUT_FULL_CUBIC_CTRL     : INTEGER := 16#18#;
    constant ADDR_PRUNED_FEATURE_DRAM_READ_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_PRUNED_FEATURE_DRAM_READ_DATA_1  : INTEGER := 16#20#;
    constant ADDR_PRUNED_FEATURE_DRAM_READ_CTRL    : INTEGER := 16#24#;
    constant ADDR_PRUNED_FEATURE_DRAM_WRITE_DATA_0 : INTEGER := 16#28#;
    constant ADDR_PRUNED_FEATURE_DRAM_WRITE_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_PRUNED_FEATURE_DRAM_WRITE_CTRL   : INTEGER := 16#30#;
    constant ADDR_BITMAP_INFO_DATA_0               : INTEGER := 16#34#;
    constant ADDR_BITMAP_INFO_DATA_1               : INTEGER := 16#38#;
    constant ADDR_BITMAP_INFO_DATA_2               : INTEGER := 16#3c#;
    constant ADDR_BITMAP_INFO_DATA_3               : INTEGER := 16#40#;
    constant ADDR_BITMAP_INFO_DATA_4               : INTEGER := 16#44#;
    constant ADDR_BITMAP_INFO_CTRL                 : INTEGER := 16#48#;
    constant ADDR_TOTAL_PROCESSED_VOXELS_DATA_0    : INTEGER := 16#64#;
    constant ADDR_TOTAL_PROCESSED_VOXELS_CTRL      : INTEGER := 16#68#;
