...
#pragma HLS PIPELINE II = 1
 ...
 static ap_uint<512> l3_cache = 0;
    ...
    ap_uint<32> l2_word_idx = l2_linear_idx / 512;
...
#pragma HLS loop_tripcount min = 1 max = 64
 ...
 ap_uint<8> bitgroup = 0;
        ...
        ap_uint<32> word_idx = (chunk + stream_ptrs.current_ptr_L1) / 512;
        ap_uint<32> bit_idx = (chunk + stream_ptrs.current_ptr_L1) % 512;
        ...
        else
        {
            ...
            if (word_idx + 1 < 64)
            {
                temp |= (L1_bitmap_pruned[word_idx + 1] << (512 - bit_idx));
            }
            bitgroup = temp & 0xFF;
        }
