...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_bitset_512ns_512ns_32s_1s_512_1_1 BINDTYPE {op} TYPE {bitset} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_bitset_512ns_512ns_32s_1ns_512_1_1 BINDTYPE {op} TYPE {bitset} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_bitset_8ns_8ns_32ns_1ns_8_1_1 BINDTYPE {op} TYPE {bitset} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_bitselect_1ns_8ns_32ns_1_1_1 BINDTYPE {op} TYPE {bitselect} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_streaming_bitmap_constructor_L1_temp_RAM_1P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_1p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler minkowski_net_14_layer_pipeline_streaming_bitmap_constructor_L2_temp_RAM_1P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_1p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
